        ...
        <div class="header sticky">
            <div class="container">
                <div class="header-wrapper">
                    ...
                    <%-- Link to Github account: https://github.com/Dandamaev --%>
                    <a id="link-to-git" target="_blank" href="https://github.com/Dandamaev">Github<img
        ...
        <div class="footer">
            <div class="container">
                <div class="footer-inner ">
                    ...
                    <a class="text" href="https://github.com/Dandamaev" target="_blank">Dandamaev</a>
                </div>
            </div>
        </div>
        <%-- Scripts --%>
